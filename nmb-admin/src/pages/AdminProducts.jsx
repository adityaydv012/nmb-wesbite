...
const AdminProducts = () => {
  ...
  const [gstLoading, setGstLoading] =
    useState(true);
  ...
  const [gstSuccess, setGstSuccess] =
    useState("");
  ...
  const handleSubmit = async (
    ...
    if (
      validVarieties.length === 0
    ) {
      setError(
        "Please add at least one valid product variety."
      );
      return;
    }
  ...
  return (
    <AdminLayout>
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 rounded-2xl border border-[#eadfda] bg-white p-5 shadow-sm md:p-6">

          <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-center">

            <div className="flex items-start gap-4">

              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#f0e5f3] text-[#40134f]">
                <Percent size={23} />
              </div>
              ...
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm leading-6 text-[#81747b]">
                  Control whether GST is charged on customer
                  orders. You can enable or disable GST anytime
          ...
          <div className="mt-6 border-t border-[#eee7e3] pt-5">
            ...
            <div className="grid gap-4 md:grid-cols-[220px_minmax(0,1fr)_auto] md:items-end">
              ...
              <div>
                ...
                <label
                  htmlFor="gstRate"
                  className="mb-2 block text-xs font-bold uppercase tracking-wide text-[#655961]"
                >
                  GST Percentage
                </label>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-[#ded2cd] bg-white px-4 py-3 pr-10 text-sm font-semibold text-[#241a1c] outline-none transition focus:border-[#40134f] focus:ring-2 focus:ring-[#eadcf0] disabled:cursor-not-allowed disabled:bg-[#f7f4f1] disabled:text-[#aaa0a5]"
                  />

                  <span className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-sm font-bold text-[#81747b]">
                    %
                  </span>
                ...
                {gstEnabled ? (
                  ...
                  <div className="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      No GST will be added to new customer
                      orders.
                    </p>
              ...
              <button
                type="button"
                onClick={
                  handleSaveGstSettings
                }
                disabled={
                  gstLoading ||
                  gstSaving
                }
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#40134f] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#32103f] disabled:cursor-not-allowed disabled:opacity-60"
              >
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <p className="mt-1 text-sm text-[#81747b]">
                        Add your first sweet product to get
                        started.
                      </p>
                    </td>
                  </tr>
                  ...
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-[#81747b]">
                        Add multiple image URLs. The first image is
                ...
                <div>
                  ...
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-[#81747b]">
                        Offer price is optional. Leave it empty for
                        no discount.
                      </p>
